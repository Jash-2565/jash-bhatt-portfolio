...
export default function ContactLinkCard({ href, icon, label, value }: ContactLinkCardProps) {
  return (
    <a href={href} target="_blank" rel="noreferrer" className="surface surface-marks relative flex items-center gap-4 p-4 lg:p-5 w-full h-full rounded-2xl card-glow group overflow-hidden">
