 ...
 * snappier. The ring only moves once per frame, so how far it trails depends on
 * the display: at 11ms a fast 1,000px/s flick trails by about 9px at 60Hz and
 * 12px at 120Hz, and ordinary 300px/s movement by about 3px.
 */
const RING_HALF_LIFE_MS = 11;
